...
namespace Dme.Core
{
    ...
    public partial class ЗаказНаРазмещениеАдрес
    {
        public ЗаказНаРазмещениеАдрес()
        {
            this.ЗаказНаРазмещениеАдрИно = new HashSet<ЗаказНаРазмещениеАдрИно>();
            this.ЗаказНаРазмещениеАдрРФ = new HashSet<ЗаказНаРазмещениеАдрРФ>();
        }
